...
public class VendorService {
    ...
    public Vendor findById(int vendorId){return vendorRepository.findById(vendorId);}

    public Result<Vendor> add(Vendor vendor){
        return null;
    }
    public Result<Vendor> update(Vendor vendor){return null;}
    public boolean deleteById(int vendorId){return false;}
